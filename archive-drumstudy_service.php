		...
		<div class="tts-container">
			<header class="tts-section-heading">
				<h1 id="archive-heading" class="tts-section-heading__title">
					<?php echo esc_html( drumstudy_get_option( 'drumstudy_archive_header_services' ) ?: __( 'Services', 'drumstudy' ) ); ?>
				</h1>
			</header>
			...
			<?php else : ?>
				<p class="py-12 text-center"><?php esc_html_e( 'No services found.', 'drumstudy' ); ?></p>
			<?php endif; ?>
		</div>
	</section>
