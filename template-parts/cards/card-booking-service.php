 ...
 *                          — embed code lives on the service post itself (service['id']),
...
$service_id    = absint( $service['id'] ?? 0 );
...
$embed_markup  = drumstudy_get_booking_service_embed( $service_id, $embed_meta_key, $title );
