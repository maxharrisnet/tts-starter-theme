			...
			<div class="tts-container">
				...
				<?php if ( $is_past ) : ?>
					<div class="tts-notice tts-notice--past mb-6" role="status">
						<?php esc_html_e( 'This event has passed.', 'drumstudy' ); ?>
					</div>
				<?php endif; ?>
					...
					<div class="w-full lg:w-2/3">
							...
							<dl class="tts-event-meta">
								<?php if ( $formatted_start ) : ?>
									<div class="tts-event-meta__item">
										<dt><?php esc_html_e( 'Date', 'drumstudy' ); ?></dt>
										<dd>
											...
											<?php if ( $end_date && $end_date !== $event_date ) :
												...
												?>
												<span> <?php esc_html_e( 'to', 'drumstudy' ); ?> </span>
								...
								<?php if ( $location_name || $location_addr ) : ?>
									<div class="tts-event-meta__item">
										<dt><?php esc_html_e( 'Location', 'drumstudy' ); ?></dt>
										<dd>
								...
								<?php if ( $organizer ) : ?>
									<div class="tts-event-meta__item">
										<dt><?php esc_html_e( 'Organizer', 'drumstudy' ); ?></dt>
								...
								<?php if ( $ticket_price ) : ?>
									<div class="tts-event-meta__item">
										<dt><?php esc_html_e( 'Price', 'drumstudy' ); ?></dt>
						...
						<?php if ( $embed_block ) : ?>
							<div class="tts-embed-block mt-8">
								<?php echo drumstudy_render_embed( $embed_block ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
							</div>
						<?php endif; ?>

						<?php if ( ! $is_past && $ticket_url ) : ?>
							<div class="tts-cta-strip mt-10">
								<?php drumstudy_render_cta( __( 'Get Tickets', 'drumstudy' ), $ticket_url ); ?>
							</div>
						<?php endif; ?>
					</div>
