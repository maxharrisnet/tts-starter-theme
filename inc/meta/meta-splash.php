...
add_action(
	...
	function ( WP_Post $post ): void {
		...
		add_meta_box( 'drumstudy_splash_meta', __( 'Splash / Coming Soon Settings', 'drumstudy' ), 'drumstudy_splash_meta_cb', 'page', 'normal', 'high' );
	}
);
 ...
 */
function drumstudy_splash_meta_cb( WP_Post $post ): void {
	wp_nonce_field( 'drumstudy_save_splash_meta', 'drumstudy_splash_nonce' );
	...
	<div class="tts-meta-grid">
		<div class="tts-meta-row">
			<label for="splash_headline" class="tts-meta-label"><?php esc_html_e( 'Main Headline', 'drumstudy' ); ?></label>
			<input type="text" id="splash_headline" name="splash_headline" value="<?php echo esc_attr( $headline ); ?>" class="widefat" />
			<p class="description"><?php esc_html_e( 'Where it appears: Primary headline on the splash/coming soon page.', 'drumstudy' ); ?></p>
		</div>
		<div class="tts-meta-row">
			<label for="splash_subheadline" class="tts-meta-label"><?php esc_html_e( 'Subheadline', 'drumstudy' ); ?></label>
		...
		<div class="tts-meta-row tts-meta-row--full">
			<label for="splash_body" class="tts-meta-label"><?php esc_html_e( 'Supporting Copy', 'drumstudy' ); ?></label>
			<textarea id="splash_body" name="splash_body" rows="4" class="widefat"><?php echo esc_textarea( $body ); ?></textarea>
		</div>
		<div class="tts-meta-row">
			<label class="tts-meta-label"><?php esc_html_e( 'Logo Override (optional)', 'drumstudy' ); ?></label>
			...
			<button type="button" class="button tts-media-upload-btn" data-field="splash_logo_override" data-preview="splash_logo_override_preview"><?php esc_html_e( 'Select Logo', 'drumstudy' ); ?></button>
			<?php if ( $logo_id ) : ?>
				<button type="button" class="button tts-media-remove-btn" data-field="splash_logo_override" data-preview="splash_logo_override_preview"><?php esc_html_e( 'Remove', 'drumstudy' ); ?></button>
			<?php endif; ?>
			<p class="description"><?php esc_html_e( 'Overrides the global logo for the splash page only.', 'drumstudy' ); ?></p>
		</div>
		<div class="tts-meta-row">
			<label class="tts-meta-label"><?php esc_html_e( 'Background Image', 'drumstudy' ); ?></label>
			...
			<button type="button" class="button tts-media-upload-btn" data-field="splash_bg_image" data-preview="splash_bg_image_preview"><?php esc_html_e( 'Select Image', 'drumstudy' ); ?></button>
			<?php if ( $bg_id ) : ?>
				<button type="button" class="button tts-media-remove-btn" data-field="splash_bg_image" data-preview="splash_bg_image_preview"><?php esc_html_e( 'Remove', 'drumstudy' ); ?></button>
			<?php endif; ?>
		</div>
		<div class="tts-meta-row">
			<label for="splash_cta1_label" class="tts-meta-label"><?php esc_html_e( 'Primary CTA Label', 'drumstudy' ); ?></label>
		...
		<div class="tts-meta-row">
			<label for="splash_cta1_url" class="tts-meta-label"><?php esc_html_e( 'Primary CTA URL', 'drumstudy' ); ?></label>
			<input type="text" id="splash_cta1_url" name="splash_cta1_url" value="<?php echo esc_attr( $cta1_url ); ?>" class="widefat" />
		</div>
		<div class="tts-meta-row">
			<label for="splash_cta2_label" class="tts-meta-label"><?php esc_html_e( 'Secondary CTA Label (optional)', 'drumstudy' ); ?></label>
			<input type="text" id="splash_cta2_label" name="splash_cta2_label" value="<?php echo esc_attr( $cta2_label ); ?>" class="widefat" />
		</div>
		<div class="tts-meta-row">
			<label for="splash_cta2_url" class="tts-meta-label"><?php esc_html_e( 'Secondary CTA URL', 'drumstudy' ); ?></label>
			<input type="text" id="splash_cta2_url" name="splash_cta2_url" value="<?php echo esc_attr( $cta2_url ); ?>" class="widefat" />
		</div>
		<div class="tts-meta-row tts-meta-row--full">
			<label for="splash_embed_block" class="tts-meta-label"><?php esc_html_e( 'Embed / Waitlist Form', 'drumstudy' ); ?></label>
			<textarea id="splash_embed_block" name="splash_embed_block" rows="4" class="widefat"><?php echo esc_textarea( $embed_block ); ?></textarea>
			<p class="description"><?php esc_html_e( 'Where it appears: Below CTAs on splash page. Accepts form shortcodes, waitlist embeds, or custom code.', 'drumstudy' ); ?></p>
		</div>
		<div class="tts-meta-row tts-meta-row--full">
			<label class="tts-meta-label"><?php esc_html_e( 'PDF Download (optional)', 'drumstudy' ); ?></label>
			<input type="hidden" id="splash_pdf" name="splash_pdf" value="<?php echo esc_attr( (string) $pdf_id ); ?>" />
			<?php if ( $pdf_id ) : ?>
				<p><?php echo esc_html( $pdf_title ); ?></p>
			<?php endif; ?>
			<button type="button" class="button tts-media-upload-btn" data-field="splash_pdf" data-preview="" data-type="application/pdf"><?php esc_html_e( 'Select PDF', 'drumstudy' ); ?></button>
			<?php if ( $pdf_id ) : ?>
				<button type="button" class="button tts-media-remove-btn" data-field="splash_pdf" data-preview=""><?php esc_html_e( 'Remove', 'drumstudy' ); ?></button>
			<?php endif; ?>
			<p class="description"><?php esc_html_e( 'Where it appears: PDF download link on splash page. Accepts PDF files only. Stored as attachment ID.', 'drumstudy' ); ?></p>
		</div>
	</div>
	<?php
}
 ...
 */
function drumstudy_save_splash_meta( int $post_id ): void {
	if ( ! isset( $_POST['drumstudy_splash_nonce'] )
		|| ! wp_verify_nonce( sanitize_key( $_POST['drumstudy_splash_nonce'] ), 'drumstudy_save_splash_meta' ) ) {
		return;
	}
...
add_action( 'save_post', 'drumstudy_save_splash_meta' );
