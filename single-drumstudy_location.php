						...
						<?php if ( $map_embed ) : ?>
							<div class="tts-map-embed mt-8">
								<iframe src="<?php echo esc_url( $map_embed ); ?>"
								        ...
								        title="<?php printf( esc_attr__( 'Map for %s', 'drumstudy' ), get_the_title() ); ?>">
								</iframe>
							</div>
						<?php endif; ?>
					</div>
					...
					<aside class="w-full lg:w-1/3">
						...
						<?php if ( $address1 ) : ?>
							<address class="tts-address not-italic mb-6">
								<strong><?php esc_html_e( 'Address', 'drumstudy' ); ?></strong>
						...
						<?php if ( $phone ) : ?>
							<p>
								<strong><?php esc_html_e( 'Phone', 'drumstudy' ); ?></strong>
						...
						<?php if ( $email ) : ?>
							<p>
								<strong><?php esc_html_e( 'Email', 'drumstudy' ); ?></strong>
						...
						<?php if ( $hours ) : ?>
							<div class="tts-hours">
								<strong><?php esc_html_e( 'Hours', 'drumstudy' ); ?></strong>
