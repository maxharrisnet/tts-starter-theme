		...
		<div class="tts-container">
			<header class="tts-section-heading">
				<h1 id="archive-heading" class="tts-section-heading__title">
					<?php echo esc_html( tts_get_option( 'tts_archive_header_services' ) ?: __( 'Services', 'tts-theme' ) ); ?>
				</h1>
			</header>
			...
			<?php else : ?>
				<p class="py-12 text-center"><?php esc_html_e( 'No services found.', 'tts-theme' ); ?></p>
			<?php endif; ?>
		</div>
	</section>
